 ...
 * @author Albert
 */
public class MascotasR extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MascotasR.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
