...
public class mainPHL extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Cliente.setFont(new java.awt.Font("Comic Sans MS", 1, 16)); // NOI18N
        Cliente.setText("Clientes");
        Cliente.setPreferredSize(new java.awt.Dimension(250, 24));
        ...
        RInventario.setFont(new java.awt.Font("Comic Sans MS", 1, 16)); // NOI18N
        RInventario.setText("Registro de Inventario");
        Inventario.add(RInventario);
    ...
    public JMenuItem getRInventario() {
        return RInventario;
    }
